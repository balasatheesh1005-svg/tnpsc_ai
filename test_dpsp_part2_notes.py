# -*- coding: utf-8 -*-
"""
Validation & Verification Test Suite for DPSP Part 2 Notes
"""
...
def test_dpsp_part2_notes_flow():
    print("================================================================================")
    print("🚀 RUNNING TNPSC NOVA AI - DPSP PART 2 NOTES VERIFICATION SUITE")
    print("================================================================================")

    # 1. File existence & JSON parsing
    note_path = "data/notes/polity/directive_principles_part_2.json"
    ...
    meta = data.get("meta", {})
    assert meta.get("topic_id") == "polity_directive_principles_part_2", f"❌ Invalid topic_id: {meta.get('topic_id')}"
    ...
    # Check key section blocks (Articles 40 to 47 & 43A)
    required_sec_keys = [
        "sec_article_40", "sec_article_41", "sec_article_42", "sec_article_43",
        "sec_article_43a", "sec_article_44", "sec_article_45", "sec_article_46",
        "sec_article_47", "sec_classification_cases", "sec_traps_revision"
    ]
    ...
    topic_meta = get_topic_metadata_by_id("polity", "polity_directive_principles_part_2")
    assert topic_meta is not None, "❌ Failed to load topic metadata for polity_directive_principles_part_2"
    assert topic_meta["part"] == 2 and topic_meta["total_parts"] == 3

    avail = check_repository_availability("polity", "polity_directive_principles_part_2")
    print(f"   - Part 2 Availability: {avail}")
    assert avail.get("notes") == True, "❌ Part 2 Notes not reported available!"

    # Regression check on Part 1
    ...
    print("\n================================================================================")
    print("🏆 ALL VERIFICATION CHECKS PASSED FOR DPSP PART 2 NOTES!")
    print("================================================================================")

if __name__ == "__main__":
    test_dpsp_part2_notes_flow()
