# -*- coding: utf-8 -*-
"""
Validation & Verification Test Suite for DPSP Hard 50 MCQs
"""
...
def test_dpsp_hard_mcqs_flow():
    print("================================================================================")
    print("🚀 RUNNING TNPSC NOVA AI - DPSP HARD 50 MCQs VERIFICATION SUITE")
    print("================================================================================")

    # 1. File existence & JSON parsing
    q_path = "data/questions/polity/directive_principles_hard.json"
    ...
    for idx, q in enumerate(questions, 1):
        ...
        # Difficulty & Topic
        assert q["difficulty"] == "Hard", f"❌ Question {idx} invalid difficulty: {q['difficulty']}"
    ...
    for part_num in [1, 2, 3]:
        ...
        loaded_qs = load_questions("polity", t_id, "hard")
        assert loaded_qs is not None, f"❌ Failed to load hard questions for {t_id}"
        assert len(loaded_qs) == 50, f"❌ Loaded {len(loaded_qs)} questions for {t_id}, expected 50!"
        assert loaded_qs[0]["id"] == "DPSP_H_001", f"❌ Mismatched repository loaded for {t_id}!"
        print(f"   - Part {part_num} (`{t_id}`) -> Loaded 50 questions from common repository -> PASSED")

    print("\n================================================================================")
    print("🏆 ALL VERIFICATION CHECKS PASSED FOR DPSP HARD 50 MCQs!")
    print("================================================================================")

if __name__ == "__main__":
    test_dpsp_hard_mcqs_flow()
