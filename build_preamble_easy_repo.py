# build_preamble_easy_repo.py
import json
import os
from collections import Counter
from preamble_easy_q1_25 import get_q1_25
from preamble_easy_q26_50 import get_q26_50
...
def assemble_and_save():
    ...
    out_file = os.path.join(out_dir, "preamble_easy.json")

    with open(out_file, "w", encoding="utf-8") as f:
        json.dump(all_qs, f, ensure_ascii=False, indent=2)

    print(f"\nSUCCESSFULLY SAVED PREAMBLE EASY 50 REPOSITORY AT:")
    print(f"   {out_file}")
