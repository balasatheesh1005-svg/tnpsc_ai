...
questions.append(make_q(
    ...
    "Neither 1 nor 2", "1 மற்றும் 2 இரண்டும் இல்லை",
    "C",
    "Both statements are correct. Charter Act 1853 separated legislative and executive functions of GG Council (created Indian Legislative Council) and opened Civil Services to open competition (Macaulay Comm 1854).",
    ...
    "Incorrect. Both statements are correct.",
    "தவறு. இரண்டு கூற்றுகளும் சரியானவை.",
    "The 1853 Act introduced local representation in the Central Legislative Council for the first time (4 members from Madras, Bombay, Bengal, Agra).",
    "1853 சட்டம் மத்திய சட்டமன்ற கவுன்சிலில் உள்ளூர் பிரதிநிதித்துவத்தை (மதராஸ், பம்பாய், வங்காளம், ஆக்ரா) முதன்முறையாக அறிமுகப்படுத்தியது.",
...
questions.append(make_q(
    ...
    "Neither 1 nor 2", "1 மற்றும் 2 இரண்டும் இல்லை",
    "C",
    "Both statements are correct. GOI Act 1858 ended Double Government (abolished Board of Control and Directors) and created Secretary of State for India assisted by a 15-member advisory Council of India.",
    ...
    "Incorrect. Both statements are correct.",
    "தவறு. இரண்டு கூற்றுகளும் சரியானவை.",
    "GOI Act 1858 changed the designation of Governor-General of India to Viceroy of India (Lord Canning became first Viceroy).",
...
questions.append(make_q(
    ...
    "Neither 1 nor 2", "1 மற்றும் 2 இரண்டும் இல்லை",
    "A",
    "Statement 1 is correct (restored legislative powers to Bombay/Madras, reversing 1833 Act). Statement 2 is INCORRECT because Viceroy's Ordinance validity was SIX MONTHS, not one year.",
...
questions.append(make_q(
    ...
    "Neither 1 nor 2", "1 மற்றும் 2 இரண்டும் இல்லை",
    "A",
    "Statement 1 is correct (increased non-official members). Statement 2 is INCORRECT because 1892 Act allowed ONLY budget discussion and asking questions with 6 days notice; it did NOT permit supplementary questions or voting on the budget (these came in 1909 and 1919).",
...
print(f"Added up to Q10 ({len(questions)} total questions).")
