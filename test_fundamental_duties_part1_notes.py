# -*- coding: utf-8 -*-
"""
Verification & Validation Test Suite for Fundamental Duties Part 1 Notes
"""
...
def test_fundamental_duties_part1_notes_flow():
    print("================================================================================")
    print("🚀 RUNNING TNPSC NOVA AI - FUNDAMENTAL DUTIES PART 1 NOTES VERIFICATION SUITE")
    print("================================================================================")

    # 1. File existence & JSON parsing
    note_path = "data/notes/polity/fundamental_duties_part_1.json"
    ...
    meta = data.get("meta", {})
    assert meta.get("topic_id") == "polity_fundamental_duties_part_1", f"❌ Invalid topic_id: {meta.get('topic_id')}"
    ...
    required_sec_keys = [
        "sec_fd_overview", "sec_constitutional_history", "sec_swaran_singh",
        "sec_article_51a_structure", "sec_conceptual_distinctions",
        "sec_justiciability_enforcement", "sec_cases_legal_context",
        "sec_amendments"
    ]
    ...
    # 5. Mandatory Comparison Tables Audit (8 Tables Required)
    print("\n[STEP 5] Verifying Mandatory 8 Comparison Tables")
    tables = content.get("tables", [])
    assert len(tables) >= 8, f"❌ Expected at least 8 comparison tables, found {len(tables)}"
    ...
    print(f"   ✅ All {len(tables)} comparison tables verified.")
    ...
    topic_meta = get_topic_metadata_by_id("polity", "polity_fundamental_duties_part_1")
    assert topic_meta is not None, "❌ Failed to load topic metadata for polity_fundamental_duties_part_1"
    assert topic_meta["part"] == 1 and topic_meta["total_parts"] == 3

    avail = check_repository_availability("polity", "polity_fundamental_duties_part_1")
    ...
    print("\n================================================================================")
    print("🏆 ALL VERIFICATION CHECKS PASSED FOR FUNDAMENTAL DUTIES PART 1 NOTES!")
    print("================================================================================")

if __name__ == "__main__":
    test_fundamental_duties_part1_notes_flow()
