# -*- coding: utf-8 -*-
"""
Validation & Verification Test Suite for DPSP Medium 50 MCQs
"""
...
def test_dpsp_medium_mcqs_flow():
    print("================================================================================")
    print("🚀 RUNNING TNPSC NOVA AI - DPSP MEDIUM 50 MCQs VERIFICATION SUITE")
    print("================================================================================")

    # 1. File existence & JSON parsing
    q_path = "data/questions/polity/directive_principles_medium.json"
    ...
    assert key_counts["A"] >= 10 and key_counts["B"] >= 10 and key_counts["C"] >= 10 and key_counts["D"] >= 10, "❌ Unbalanced answer distribution!"
    ...
    for part_num in [1, 2, 3]:
        ...
        assert loaded_qs[0]["id"] == "DPSP_M_001", f"❌ Mismatched repository loaded for {t_id}!"
        print(f"   - Part {part_num} (`{t_id}`) -> Loaded 50 questions from common repository -> PASSED")

    print("\n================================================================================")
    print("🏆 ALL VERIFICATION CHECKS PASSED FOR DPSP MEDIUM 50 MCQs!")
    print("================================================================================")

if __name__ == "__main__":
    test_dpsp_medium_mcqs_flow()
