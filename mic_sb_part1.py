...
questions.append(make_q(
    ...
    "A",
    "Statements 1 and 2 are correct. Statement 3 is INCORRECT because the British Government accepted the demand for a Constituent Assembly for the first time IN PRINCIPLE in the 'August Offer' of 1940, not the Cripps Proposals of 1942.",
...
questions.append(make_q(
    ...
    "1, 2 and 3", "1, 2 மற்றும் 3",
    "A",
    "Statement 1 is correct. Statement 2 is INCORRECT because Lord Pethick-Lawrence was the Chairman of the Cabinet Mission. Statement 3 is INCORRECT because the Cabinet Mission explicitly rejected the Muslim League demand for Pakistan.",
    "கூற்று 1 சரி. கூற்று 2 தவறு, ஏனெனில் இந்திய அரசுச் செயலர் பெதிக்-லாரன்ஸ் பிரபுவே கேபினட் தூதுக்குழுவின் தலைவராவார். கூற்று 3 தவறு, ஏனெனில் கேபினட் தூதுக்குழு பாகிஸ்தான் கோரிக்கையை நிராகரித்தது.",
...
questions.append(make_q(
    ...
    "1, 2 and 3", "1, 2 மற்றும் 3",
    "A",
    "Statements 1 and 2 are correct. Statement 3 is INCORRECT because the Constituent Assembly was INDIRECTLY elected by the members of the provincial legislative assemblies, not by direct adult franchise.",
...
questions.append(make_q(
    ...
    "1, 2 and 3", "1, 2 மற்றும் 3",
    "B",
    "Statements 1 and 3 are correct. Statement 2 is INCORRECT because the Princely States initially decided to stay away from the Constituent Assembly and did not attend the first meeting on Dec 9, 1946.",
    "கூற்றுகள் 1 மற்றும் 3 சரி. கூற்று 2 தவறு, ஏனெனில் ஆரம்பத்தில் சுதேச சமஸ்தானங்கள் அவையிலிருந்து விலகியிருக்க முடிவு செய்து டிசம்பர் 9, 1946 கூட்டத்தில் பங்கேற்கவில்லை.",
...
questions.append(make_q(
    ...
    "1, 2 and 3", "1, 2 மற்றும் 3",
    "D",
    "All three statements are correct. Congress won 208 seats, Muslim League won 73, independents won 15 out of 296 British India seats. Mahatma Gandhi and M.A. Jinnah were notable exceptions who were NOT members of the Assembly.",
...
questions.append(make_q(
    ...
    "1, 2 and 3", "1, 2 மற்றும் 3",
    "D",
    "All three statements are correct. There were 15 women members in the Constituent Assembly. Begum Aizaz Rasul was the sole Muslim woman member.",
    "மூன்று கூற்றுகளும் சரி. அவையில் மொத்தம் 15 பெண் உறுப்பினர்கள் இருந்தனர். பேகம் ஐசாஸ் ரசூல் மட்டுமே ஒரே முஸ்லிம் பெண் உறுப்பினர்.",
...
questions.append(make_q(
    ...
    "1, 2 and 3", "1, 2 மற்றும் 3",
    "B",
    "Statements 2 and 3 are correct. Statement 1 is INCORRECT because only 211 members attended the first meeting on Dec 9, 1946.",
...
questions.append(make_q(
    ...
    "1, 2 and 3", "1, 2 மற்றும் 3",
    "A",
    "Statements 1 and 3 are correct. Statement 2 is INCORRECT because the Objectives Resolution was NOT adopted on the day of introduction (Dec 13, 1946). It was adopted on January 22, 1947.",
...
questions.append(make_q(
    ...
    "1, 2 and 3", "1, 2 மற்றும் 3",
    "A",
    "Statements 1 and 2 are correct. Statement 3 is INCORRECT because Dr. Rajendra Prasad chaired the Steering Committee (and Rules of Procedure Committee), NOT Dr. B.R. Ambedkar.",
