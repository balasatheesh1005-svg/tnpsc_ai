# -*- coding: utf-8 -*-
"""
Verification Suite for Fundamental Rights - Part 2 Notes (Full Audit)
"""
...
def run_fr_part2_notes_verification():
    print("================================================================================")
    print("🚀 RUNNING TNPSC NOVA AI - FUNDAMENTAL RIGHTS PART 2 NOTES VERIFICATION SUITE")
    print("================================================================================")

    # 1. File Existence & JSON parsing
    note_path = "data/notes/polity/fundamental_rights_part_2.json"
    ...
    meta = data.get("meta", {})
    assert meta.get("topic_id") == "polity_fundamental_rights_part_2", "❌ Incorrect topic_id"
    assert meta.get("repository_id") == "polity_fundamental_rights", "❌ Incorrect repository_id"
    assert meta.get("part") == 2, "❌ Part must be 2"
    ...
    expected_sec_ids = [
        "sec_article_19", "sec_reasonable_restrictions", "sec_article_20",
        "sec_article_21", "sec_article_21a", "sec_article_22",
        "sec_preventive_detention", "sec_article_23", "sec_article_24",
        "sec_case_laws_part2", "sec_traps_connections_part2"
    ]
    ...
    expected_tbls = [
        "tbl_art19_six_freedoms",
        "tbl_art19_restrictions",
        "tbl_art20_three_protections",
        "tbl_art20_vs_art21",
        "tbl_art21_vs_art21a",
        "tbl_punitive_vs_preventive",
        "tbl_art22_arrest_safeguards",
        "tbl_art23_vs_art24"
    ]
    ...
    meta_info = get_topic_metadata_by_id("polity", "polity_fundamental_rights_part_2")
    assert meta_info is not None, "❌ Topic not discovered by topics_loader!"
    assert meta_info["display_title"] == "Fundamental Rights – Part 2"
    
    nav_avail = check_repository_availability("polity", "polity_fundamental_rights_part_2")
    ...
    print("\n================================================================================")
    print("🎉 ALL 8 VERIFICATION STEPS PASSED WITH 100% SUCCESS FOR PART 2!")
    print("================================================================================")

if __name__ == "__main__":
    run_fr_part2_notes_verification()
