# -*- coding: utf-8 -*-
"""
End-to-End Practice & Grand Test Engine Simulation for President MCQ Datasets
"""
...
def test_president_practice_ui_simulation():
    print("================================================================================")
    print("🧪 PRESIDENT MCQ DATASETS: UI & PRACTICE ENGINE INTERACTIVE SIMULATION")
    print("================================================================================")
    ...
    for mode, expected_count in datasets:
        ...
        # 1. Load questions
        qs = load_questions("polity_president", mode)
        ...
        success = start_practice_session(
            ...
            display_title=f"President - {mode.title()}",
    ...
    print("\n================================================================================")
    if all_passed:
        print("🎉 ALL 8 PRESIDENT MCQ DATASETS PASSED UI & PRACTICE ENGINE SIMULATION 100%!")
    else:
        print("❌ UI SIMULATION FAILED!")
    print("================================================================================")

if __name__ == "__main__":
    test_president_practice_ui_simulation()
